    ...
    <div className="relative z-10 max-w-[1200px] w-full mx-auto">
      ...
      <div className="grid lg:grid-cols-2 gap-10 sm:gap-14 lg:gap-16 items-center fade-up">
        <div className="space-y-4 sm:space-y-6">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-blue-main leading-tight">
            Founder’s Message
          </h2>
          ...
          <div className="pt-2 sm:pt-4">
            <p className="text-gray-200 italic text-base sm:text-lg">
        ...
        <div className="relative bg-[#0E1625]/70 backdrop-blur-xl border border-blue-main/20 rounded-2xl p-6 sm:p-8 md:p-10 shadow-[0_0_30px_-10px_#00AEEF40]">
          <p className="text-gray-200 italic leading-relaxed text-sm sm:text-base mb-6 sm:mb-8">
      ...
      <div className="text-center fade-up">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-blue-main mb-4 sm:mb-6">
          Company Overview
        </h2>
        ...
        <p className="text-gray-300 text-sm sm:text-base leading-relaxed max-w-2xl mx-auto mb-10 sm:mb-12">
        ...
        <p className="text-gray-200 mt-10 sm:mt-12 text-base sm:text-lg font-medium fade-up">
